...
for num in range(1, 101):
  sum += num
print(f'La suma de todos los numeros del 1 al 10 (inclusivo) es: {sum}')

# Ejercicio 6: Tabla de multiplicar
# Pide al usuario que introduzca un número.
# Imprime la tabla de multiplicar de ese número (del 1 al 10) usando un bucle for y range().
print("\nEjercicio 6:")
multiplicar = int(input('Ingresa un numero del cual quieras ver su tabla de multiplicar: '))
contador = 0

for num in range(1, 11):
  print(f'{multiplicar} X {num} = {multiplicar * num}')
  contador+=1
